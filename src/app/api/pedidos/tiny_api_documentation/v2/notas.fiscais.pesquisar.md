...
- ++[REST](https://tiny.com.br/api-docs/api2-notas-fiscais-pesquisar#rest-service)++
...
(2) - Código da situação conforme tabela de "++[Situações das Notas Fiscais](https://tiny.com.br/api-docs/api2-tabelas-notas-fiscais)++".  
...
| retorno.codigo_erro (1)                                                           | int     | -       | opcional        | Conforme tabela "++[Códigos de erro](https://tiny.com.br/api-docs/api2-tabelas-processamento)++"                          |
...
| retorno.notas_fiscais[ ].nota_[fiscal.id](http://fiscal.id)                       | int     | -       | opcional        | Número de identificação da nota fiscal na Olist                                                                           |
...
| retorno.notas_fiscais[ ].nota_[fiscal.data](http://fiscal.data)_emissao (4)       | date    | 10      | opcional        | Data de emissão da nota fiscal                                                                                            |
...
| retorno.notas_fiscais[ ].nota_[fiscal.cliente.ie](http://fiscal.cliente.ie)       | string  | 18      | opcional        | Inscrição estadual do cliente                                                                                             |
...
| retorno.notas_fiscais[ ].nota_fiscal.cliente.cidade                               | string  | 30      | opcional        | Nome da cidade do cliente conforme a ++[Tabela de Cidades](https://tiny.com.br/api-docs/api2-tabelas-municipios)++        |
...
| retorno.notas_fiscais[ ].nota_[fiscal.cliente.email](http://fiscal.cliente.email) | string  | 40      | opcional        | E-mail do cliente                                                                                                         |
...
| retorno.notas_fiscais[ ].nota_fiscal.endereco_entrega.cidade                      | string  | 30      | opcional        | Nome da cidade de entrega conforme a ++[Tabela de Cidades](https://tiny.com.br/api-docs/api2-tabelas-municipios)++        |
...
| retorno.notas_fiscais[ ].nota_[fiscal.id](http://fiscal.id)_vendedor              | int     | 15      | opcional        | Número de identificação do vendedor associado a nota fiscal                                                               |
| retorno.notas_fiscais[ ].nota_fiscal.nome_vendedor                                | string  | 50      | opcional        | Nome do vendedor associado a nota fiscal                                                                                  |
| retorno.notas_fiscais[ ].nota_fiscal.situacao                                     | int     | -       | opcional        | Código conforme tabela de "++[Situações das Notas Fiscais](https://tiny.com.br/api-docs/api2-tabelas-notas-fiscais)++"    |
| retorno.notas_fiscais[ ].nota_fiscal.descricao_situacao                           | string  | 25      | opcional        | Descrição conforme tabela de "++[Situações das Notas Fiscais](https://tiny.com.br/api-docs/api2-tabelas-notas-fiscais)++" |
| retorno.notas_fiscais[ ].nota_fiscal.chave_acesso                                 | string  | 100     | opcional        | Chave de acesso da Nota Fiscal                                                                                            |
| retorno.notas_fiscais[ ].nota_[fiscal.id](http://fiscal.id)_forma_frete           | string  | 11      | opcional        | Número de identificação da forma de frete associado a nota fiscal                                                         |
| retorno.notas_fiscais[ ].nota_[fiscal.id](http://fiscal.id)_forma_envio           | string  | 11      | opcional        | Número de identificação da forma de envio associado a nota fiscall                                                        |
...
#### **[Exemplos da chamada em REST](https://tiny.com.br/api-docs/api2-notas-fiscais-pesquisar#exemplos-chamada-rest)**
...
#### **[Exemplos do retorno do serviço em JSON](https://tiny.com.br/api-docs/api2-notas-fiscais-pesquisar#exemplos-retorno-json)**
